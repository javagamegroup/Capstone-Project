...
//  multidimensional arrays someArray[height][width]
	...
	protected Map(int minEnemies, int maxEnemies, char[] enemies, int minItems, int maxItems, char[] items, int minObs, int maxObs, char[] obs, boolean vender, char[] npc_friendly)//setter for the Map.
	{
		...
		level = new Level(true, 2, minEnemies, maxEnemies, enemies, minItems, maxItems, items, minObs, maxObs, obs, vender, npc_friendly);
	}
